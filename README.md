...
### SmartOrder — Order Management Backend
REST API system for inventory and order lifecycle management.
`Java` `Spring Boot` `PostgreSQL` `JPA/Hibernate`
→ [View Repo](#)

### Personal Finance Backend
Expense tracking API with category management and analytics.
